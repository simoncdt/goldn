...
export default function OverIcon() {
  return (
    <>
      <div className="fixed z-50 right-0 top-1/2 transform md:-translate-y-1/2">
        <div className="flex flex-col items-center gap-4">
          {/* Conteneur de l'icône et du texte pour "Nous contacter" */}
          <Link
            to={"/contact"}
            className="relative flex py-1 rounded-lg w-[200px] -right-[150px] items-center bg-white shadow-md cursor-pointer transform transition-all duration-300 translate-x-0 group hover:-translate-x-[150px] hover:bg-gradient-to-r hover:from-[#B58D12] hover:to-[#F7E3A1] hover:shadow-xl"
          >
