...
export default function Footer() {
  ...
  return (
    <div className="bg-[#343437] text-white">
      <div className="bg-black py-7 flex gap-5 ">
        <img
          src={logo}
          alt=""
        />
        <div className="text-xl px-9 ">
          Leader français de lAchat dOr et de la Vente dOr Plus de 70 agences
          dans toute la France
        </div>
        <div className="  rounded-lg  flex bg-[#4A4A4B] hover:bg-green-800 ">
          <div className="rounded-lg bg-green-800 px-4 py-2 ">No Vert </div>{" "}
        ...
        <div className="grid grid-cols-2 mt-24">
          ...
          <div className=" px-3">
            ...
            <div className="text-xs">
              ...
              de vous tenir informé de nos offres et de l’évolution du marché de
              l’or. Vous pourrez vous désabonner à tout moment en cliquant sur
              le lien présent dans l’email d’envoi de la newsletter ou en vous
              rendant sur votre compte. Conformément à notre politique générale
              en matière de données personnelles, vous disposez d’un droit
              d’accès vous permettant à tout moment de connaître la nature des
              données collectées vous concernant, de demander leur rectification
              ou leur effacement. Ce droit s’exerce par simple envoi d’un email.
              Pour tout savoir sur la manière dont Gold Trade gère les données
              personnelles, vous pouvez vous reporter à notre Charte sur les
      ...
      <div className=" bg-black">
        <div className="mx-3">
          <ul className="flex text-lg pt-5 pb-5">
